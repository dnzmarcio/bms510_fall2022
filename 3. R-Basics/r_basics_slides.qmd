...
:::: {.columns}
::: {.column width="40%"}
![Vectors are stacked boxes with different lengths, but of the same type of objects](figures/vectors.png){width=40%}
:::
::: {.column width="60%"}
...
<!-- ## Matrices -->
<!-- - Vectors can be bounded into two-dimensional arrays using the \textbf{function} \textcolor{blue}{\ttfamily{cbind}}: -->
<!-- ```{r} -->
...
<!-- :::: {.columns} -->
<!-- ::: {.column width="40%"} -->
<!-- ![Matrix is a collection of vectors of the same type and length organized in a two-dimensional array](figures/matrix.png){width=40%} -->
<!-- ::: -->
<!-- ::: {.column width="60%"} -->
...
<!-- :::: {.columns} -->
<!-- ::: {.column width="30%"} -->
<!-- ![Data frame is a collection of vectors of different types organized in a two-dimensional array](figures/dataframe.png){width=80%} -->
<!-- ::: -->
<!-- ::: {.column width="70%"} -->
<!-- - Data frames are created with the \textbf{function} \textcolor{blue}{\ttfamily{data.frame}}: -->
<!-- ```{r} -->
...
<!-- :::: {.columns} -->
<!-- :::  {.column width="30%"} -->
<!-- ![Each vector component is located at a given position](figures/vector_position.png){width=80%} -->
<!-- ::: -->
<!-- ::: {.column width="70%"} -->
<!-- - Components of a vector can be accessed using the operator \textcolor{blue}{\ttfamily{{[position]}}}: -->
<!-- ```{r} -->
<!-- dwo_icecream -->
<!-- dwo_icecream[1] -->
<!-- dwo_icecream[c(1, 5)] -->
...
<!-- :::: {.columns} -->
<!-- ::: {.column width="30%"} -->
<!-- ![Each matrix component is located at a given position](figures/matrix_position.png){width=80%} -->
<!-- ::: -->
<!-- ::: {.column width="70%"} -->
<!-- - Components of a matrix can be accessed using the operator \textcolor{blue}{\ttfamily{{[position row, position column]}}}: -->
<!-- ```{r} -->
<!-- m -->
<!-- ``` -->
<!-- ::: -->
...
<!-- :::: {.columns} -->
<!-- :::  {.column width="30%"} -->
<!-- ![Each matrix component is located at a row and column](figures/matrix_position.png){width=80%} -->
<!-- ::: -->
<!-- ::: {.column width="70%"} -->
<!-- - Row and columns of a matrix can be accessed using the operator \textcolor{blue}{\ttfamily{{[position row, ]}}} and -->
<!-- \textcolor{blue}{\ttfamily{{[, position column]}}}, respectively: -->
<!-- ```{r} -->
<!-- m[5, ] -->
<!-- m[, 4] -->
<!-- ``` -->
...
<!-- :::: {.columns} -->
<!-- ::: {.column width="30%"} -->
<!-- ![Each data frame component is located at a given row and column](figures/dataframe_position.png){width=80%} -->
<!-- ::: -->
<!-- ::: {.column width="70%"} -->
<!-- - Components of a data frame can be accessed similar to a matrix; -->
<!-- - In addition, columns can be accessed be their names using the operator \textcolor{blue}{\ttfamily{{\$}}}: -->
<!-- ```{r} -->
<!-- # Subsetting columns -->
<!-- df$names -->
<!-- df$dog_lover -->
...
<!-- :::: {.columns} -->
<!-- ::: {.column width="40%"} -->
<!-- ![The function f takes the object x and transform it into f(x)](figures/function02.png){width=50%} -->
<!-- ::: -->
<!-- ::: {.column width="40%"} -->
